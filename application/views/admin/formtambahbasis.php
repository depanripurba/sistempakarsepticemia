                        ...
                        <form method="POST" action="<?= base_url('posttambahbasis') ?>">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kode_penyakit" id="kodegejala">
                                        ...
                                        <option value="<?= $pen->kode_penyakit ?>"><?= $pen->kode_penyakit ?> :
                                            <?= $pen->nama_penyakit ?> </option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="nilaigejala">Nilai Probabilitas</label>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= base_url('basispengetahuan') ?>"
                                    class="btn btn-secondary">Batal/Kembali</a>
                            </div>
                        </form>
                    </div>
                    <!-- custom isi -->
